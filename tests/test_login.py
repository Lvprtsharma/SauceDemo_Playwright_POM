...
class TestLogin:
    ...
    def test_blank_username_and_password(self, login_page: LoginPage) -> None:
        ...
        expect(login_page.page.locator(login_page.ERROR_MESSAGE)).to_have_text("Epic sadface: Username is required") 
    ...
    def test_blank_password(self, login_page: LoginPage) -> None:
        ...
        assert login_page.is_error_message_visible()
        expect(login_page.page.locator(login_page.ERROR_MESSAGE)).to_have_text("Epic sadface: Password is required") 
    ...
    def test_invalid_login(self, login_page: LoginPage) -> None:
        ...
        assert login_page.is_error_message_visible()
        expect(login_page.page.locator(login_page.ERROR_MESSAGE)).to_have_text("Epic sadface: Username and password do not match any user in this service") 
    ...
    def test_locked_out_user(self, login_page: LoginPage) -> None:
        ...
        assert login_page.is_error_message_visible()
        expect(login_page.page.locator(login_page.ERROR_MESSAGE)).to_have_text("Epic sadface: Sorry, this user has been locked out.")
